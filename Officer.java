...
public class Officer extends Employee{
	...
	public Officer(String firstName, String middleName, String lastName, String gender, boolean isMarried,
	...
	public String toString() {
		return "Officer [registryNo=" + this.registryNo + ", FirstName=" + this.getFirstName()
