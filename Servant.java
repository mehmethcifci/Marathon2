...
public class Servant extends Employee {
	...
	public Servant(String firstName, String middleName, String lastName, String gender, boolean isMarried,
	...
	public String toString() {
		return "Servant [registryNo=" + this.registryNo + ", FirstName=" + this.getFirstName()
